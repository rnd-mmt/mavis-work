...
odoo.define("responsive_custom_theme", function (require) {
    "use strict";
    ...
    AppsMenu.include({
        ...
        start: function () {
            ...
            const background = "linear-gradient(rgba(240, 240, 240, 0.9), rgba(240, 240, 240, 0.9)), url('" + url + "') !important;" 
            // console.log(background , 'backkkkkkkk')
            // this.$('.dropdown-menu').css({
            //     "background": "linear-gradient(rgba(240, 240, 240, 0.9), rgba(240, 240, 240, 0.9)), url(" + url + ") !important" ,
            //     // "background-size": "cover",
            //     // "background-repeat": "no-repeat", 
            //     // "background-color": "#fff",
            //     // "background": "linear-gradient(rgba(240, 240, 240, 0.9), rgba(240, 240, 240, 0.9)), url(" + url + ") !important" 
            // });
            this.$('.dropdown-menu').attr('style' ,'background:'+background + ";background-repeat : no-repeat !important;" + "background-size: contain !important; background-position-x: 50% !important; background-color: #ffffff !important;" );
        ...
        _searchMenus: function () {
            ...
            this.$search_results.html(
                core.qweb.render("responsive_custom_theme.MenuSearchResults", {
                    results: results,
                    widget: this,
                })
            );
    ...
    FormRenderer.include({
        ...
        _renderHeaderButtons: function () {
            ...
            const $dropdown = $(
                core.qweb.render("responsive_custom_theme.MenuStatusbarButtons")
            );
    ...
    PatchableAttachmentViewer.patch("responsive_custom_theme.AttachmentViewer", (T) => {
    ...
    ControlPanel.patch("responsive_custom_theme.ControlPanelMobile", (T) => {
    ...
    SearchPanel.patch("responsive_custom_theme.SearchPanelMobile", (T) => {
