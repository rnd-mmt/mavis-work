...
""",
	...
	'data': ['views/ks_gantt_view_assets.xml', 'views/ks_res_config_settings_view.xml', 'data/week_days_data.xml', 'security/ir.model.access.csv'],

	'qweb': ['static/src/xml/ks_gantt_view.xml', 'static/src/xml/ks_recommend_color_picker.xml'],
}
