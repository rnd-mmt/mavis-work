odoo.define('om_dynamic_reports.DynamicReportPrint', function (require) {
    "use strict";
	...
	DynamicReports.include({
		...
		_printPdf: function () {
			...
			var action = {
                ...
                'report_name': 'om_dynamic_reports.om_account_reports_pdf',
                'report_file': 'om_dynamic_reports.om_account_reports_pdf',
