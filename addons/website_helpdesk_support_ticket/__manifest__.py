...
issue operator
    ...
    'live_test_url': 'http://probuseappdemo.com/probuse_apps/website_helpdesk_support_ticket/377',#'https://youtu.be/q86OEF1KjiU', #'https://youtu.be/yaf1p2zsQzM',
    'version': '15.10.30',
    # 'category' : 'Project',
...
#                 'website_portal',
    ...
    'data':[
        ...
        'wizard/create_ambulance_request_view.xml',
