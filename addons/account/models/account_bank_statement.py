...
class AccountBankStmtCashWizard(models.Model):
    ...
    title_start = fields.Char(related="start_bank_stmt_ids.name")
    date_start = fields.Date(related="start_bank_stmt_ids.date")
    company_id_start = fields.Many2one(related="start_bank_stmt_ids.company_id")
    title_end = fields.Char(related="end_bank_stmt_ids.name")
    date_end = fields.Date(related="end_bank_stmt_ids.date")
    company_id_end = fields.Many2one(related="end_bank_stmt_ids.company_id")
    ...
    def default_get(self, fields):
        ...
        vals.update({'cashbox_lines_ids': list_cash})
