...
class MaintenanceRequest(models.Model):
    ...
    # HARNETPROD
    joborder_count = fields.Integer(compute='_smart_joborder_count', string='Job Order')
    ...
    def _smart_joborder_count(self):
        for rec in self:
            joborder_count = self.env['project.task'].search_count([('maintenance_request_id', '=', rec.id)])
            rec.joborder_count = joborder_count
