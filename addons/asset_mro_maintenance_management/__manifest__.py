...
- For more details please see Video on live preview or ask us by email...
    ...
    # 'live_test_url':  'https://youtu.be/_igMWOu1haA', #'https://youtu.be/lxZ8XApXqHg',
    'live_test_url':  'http://probuseappdemo.com/probuse_apps/asset_mro_maintenance_management/267',#'https://youtu.be/CWL1ZJN68iY',
    'data':[
