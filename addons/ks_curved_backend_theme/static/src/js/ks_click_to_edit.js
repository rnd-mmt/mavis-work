...
//                        if (Session['ks_split_view'] != 'vertical') {
                        if (result && result.ks_chatter == 'ks_chatter_right') {
                            ...
                            $('.custom_seperator').on("dragstop", function(event, ui) {
                                ...
                                ajax.jsonRpc("/ks_curved_backend_theme/save/form_width", "call", {
        ...
        _ksOnFormviewDblClick: function(ev) {
            ...
            this._rpc({
                ...
                if (result.ks_click_edit && temp_this.mode == "readonly" && !$target.is(".o_form_label, .o_field_widget") && Session.ks_curved_backend_theme_data) {
