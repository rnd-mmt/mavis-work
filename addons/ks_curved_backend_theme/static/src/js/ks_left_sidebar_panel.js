...
//        'DOMMouseScroll #AllApps': '_onPageScroll',    // Firefox
//        'mousewheel #AllApps': '_onPageScroll',        // Chrome, Safari, IE
        "click button.phone-menu-btn": "_ksOpenMobileDrawer",
        "click div.overlay": "_ksCloseMobileDrawer",
        "click div.ks-phone-menu-list .o_menu_sections a[data-menu]":"_ksMobileDrawerMenu",
...
//        // scroll down
//        if (event.originalEvent.deltaY > 0 && event.originalEvent.deltaY < 80){
...
//        }
//        // scroll up
//        else if (event.originalEvent.deltaY < 0 && event.originalEvent.deltaY > -80){
...
//        $('input[name=inputText').val('');
        this._appsMenu.$search_container.removeClass("ks-find-values");
        this._appsMenu.$search_results.empty();
        this._appsMenu.$search_input.val("");
