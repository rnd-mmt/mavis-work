odoo.define("ks_curved_backend_theme.ks_quick_settings_widget", function(require) {
    "use strict";
       ...
       **/
        willStart: async function() {
            ...
            const ks_dynamic_css = await this._rpc({
                ...
                args: [["ks_button_style", "ks_theme_style", "ks_tab_style", "ks_font_style", "ks_separator_style", "ks_checkbox_style", "ks_font_size", "ks_chatter", "ks_radio_button_style", "ks_popup_animation_style", ], ],
            });
            ...
            if (ks_dynamic_css && ks_dynamic_css.ks_button_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/buttons/${ks_dynamic_css.ks_button_style}.css`);
            }
            if (ks_dynamic_css && ks_dynamic_css.ks_theme_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/theme_style/${ks_dynamic_css.ks_theme_style}.css`);
            }
            if (ks_dynamic_css && ks_dynamic_css.ks_tab_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/tab_style/${ks_dynamic_css.ks_tab_style}.css`);
            }

            if (ks_dynamic_css && ks_dynamic_css.ks_font_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/fonts/${ks_dynamic_css.ks_font_style}.css`);
            }

            if (ks_dynamic_css && ks_dynamic_css.ks_separator_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/separators/${ks_dynamic_css.ks_separator_style}.css`);
            }

            if (ks_dynamic_css && ks_dynamic_css.ks_checkbox_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/checkbox/${ks_dynamic_css.ks_checkbox_style}.css`);
            }

            if (ks_dynamic_css && ks_dynamic_css.ks_font_size) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/fontsize/${ks_dynamic_css.ks_font_size}.css`);
            }

            if (ks_dynamic_css && ks_dynamic_css.ks_chatter == "ks_chatter_right") {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/chatter/${ks_dynamic_css.ks_chatter}.css`);
            }

            if (ks_dynamic_css && ks_dynamic_css.ks_radio_button_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/radiobutton/${ks_dynamic_css.ks_radio_button_style}.css`);
            }

            if (ks_dynamic_css && ks_dynamic_css.ks_popup_animation_style) {
                ajax.loadCSS(`/ks_curved_backend_theme/static/src/scss/components/popup_animation/${ks_dynamic_css.ks_popup_animation_style}.css`);
            }
       ...
       **/
        ...
        _onInputChange: function(ev) {
            ...
            if (ev.target.name) {
                ...
                if ($(ev.currentTarget).hasClass("ks_binary_field")) {
                    ...
                    if (file_node.getAttribute("data-model")) {
                        ...
                        utils.getDataURLFromFile(file).then(function(data) {
                            ...
                            ajax.jsonRpc("/ks_curved_backend_theme/add/images", "call", {
                                image_info: {
                                    key: field_name,
                                    value: data
                                },
                ...
                if (_field == "ks_auto_dark_mode" && _value && !session.ks_curved_backend_theme_data.ks_sun_time_info) {
        ...
        _ksGlobalSettings: function(ev) {
            ...
            var dict = {
                ...
                context: {
                    form_view_ref: "ks_curved_backend_theme.ks_global_configuration_form",
                },
            };
        ...
        _ksResetValues: function() {
            ...
            for (var index in this.ks_unsaved_setting) {
                if (typeof session.ks_curved_backend_theme_data[index] == "boolean") {
                    if (index in self.ks_dirty_data) {
                        self.ks_dirty_data[index].prop("checked", session.ks_curved_backend_theme_data[index]);
                    } else {
                        $("input#" + index).prop("checked", session.ks_curved_backend_theme_data[index]);
                    }
                    ...
                    delete this.ks_unsaved_setting[index];
                        ...
                        $("input#" + session.ks_curved_backend_theme_data[index]).prop("checked", true);
                    delete this.ks_unsaved_setting[index];
            ...
            if ("ks_dark_mode"in this.ks_unsaved_setting) {
                this._ksManageAutoDarkMode(session.ks_curved_backend_theme_data.ks_dark_mode);
            }
            // Hide/Show Auto-dark mode
            if ("ks_dark_mode"in this.ks_unsaved_setting) {
                this._ksManageAutoDarkMode(session.ks_curved_backend_theme_data.ks_dark_mode);
        ...
        _KsResetDirtyData: function(session) {
            ...
            for (var index in self.ks_dirty_data) {
                if (index && self.ks_dirty_data[index] && (index in self.ks_dirty_data) && self.ks_dirty_data[index].attr('type') == 'range') {
                    ...
                    self.ks_dirty_data[index].val(session.ks_curved_backend_theme_data[index])
                    ...
                    var active_rec = session.ks_curved_backend_theme_data[self.ks_dirty_data[index].data('field-save')].filter(x=>x.ks_active)
                    ...
                    var val = session.ks_curved_backend_theme_data[self.ks_dirty_data[index].attr('name')]
                    ...
                    $('input[name=' + self.ks_dirty_data[index].attr('name') + '][data-value="' + session.ks_curved_backend_theme_data[self.ks_dirty_data[index].data('field-save')] + '"]').prop('checked', true);
                }
            }
            self.ks_dirty_data = {}
        },
