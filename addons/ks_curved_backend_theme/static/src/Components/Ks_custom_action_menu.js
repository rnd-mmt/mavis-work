odoo.define('ks_curved_backend_theme.Ks_custom_action_menu.js', function (require) {
    "use strict";
    ...
    const KsDropdownMenu = require('ks_curved_backend_theme.KsDropdownMenu');
     ...
     */
    class KsActionMenus extends Component {
        ...
        async willStart() {
            ...
            this.ks_all_data = {'actions': this.actionItems,'print_actions': this.printItems}
            this.ks_all_items = this.printItems.concat(this.actionItems);
        }
        ...
        async _setActionItems(props) {
            ...
            // KsActionMenus action registry components
    ...
    KsActionMenus.registry = new Registry();

    KsActionMenus.components = { DropdownMenu,KsDropdownMenu};
    KsActionMenus.props = {
    ...
    ControlPanel.components.KsActionMenus = KsActionMenus;
    KsActionMenus.template = 'ks_curved_backend_theme.KsActionMenus';

    return KsActionMenus;
});