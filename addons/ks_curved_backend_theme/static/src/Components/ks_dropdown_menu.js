odoo.define('ks_curved_backend_theme.KsDropdownMenu', function (require) {
    "use strict";
    ...
    KsDropdownMenu.components = { DropdownMenuItem };
    KsDropdownMenu.defaultProps = { items: [] };
    KsDropdownMenu.props = {
    ...
    KsDropdownMenu.template = 'ks_curved_backend_theme.KsDropdownMenu';

    return KsDropdownMenu;
});
