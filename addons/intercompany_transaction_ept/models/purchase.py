...
class PurchaseOrder(models.Model):
    ...
    def _prepare_invoice(self):
        ...
        if self.inter_company_transfer_id:
            ...
            vals.update({'inter_company_transfer_id': ict.id, 'department_id': self.department_id.id})
    ...
    def button_confirm(self):
        ...
        for order in self:
            ...
            if order.inter_company_transfer_id:
                sale_order = order.inter_company_transfer_id.sudo().sale_order_ids.filtered(lambda x: x.state != "cancel")
