...
class Warehouse(models.Model):
    ...
    def create_ict_for_unassigned_moves(self, warehouse_id):
        ...
        unassigned_moves = stock_move_obj.search([("warehouse_id", "=", warehouse_id),
        ...
        if ict_lines_list:
            ...
            if not ict.auto_workflow_id:
                log_book = ict_log_obj.create_ict_log_book(ict, operation_type="auto")
                log_book.post_log_line(
                    """No Workflow is set as Default to process the Auto generated %s transfer.""" % ict_type)
                return False
            ...
            if stock_not_available:
                log_book = ict_log_obj.create_ict_log_book(ict, operation_type="auto")
                log_book.post_log_line("Enough Stock is not available in Source Warehouse.\nCouldn't fulfill pickings.")
