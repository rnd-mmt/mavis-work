    ...
    def _compute_account_analytic_id(self):
        for rec in self:
            if not rec.account_analytic_id:
                ...
                rec.account_analytic_id = default_analytic_account.analytic_id or rec.product_id.categ_id.property_account_analytic_categ_id
    ...
    def _compute_analytic_tag_ids(self):
        for rec in self:
            if not rec.analytic_tag_ids:
                ...
                rec.analytic_tag_ids = default_analytic_account.analytic_tag_ids or rec.product_id.categ_id.property_account_tags_categ_id
