...
class AcsImagingRequest(models.Model):
    _inherit = 'acs.imaging.request'
    ...
    def prepare_test_result_data(self, line, patient):
        res = super(AcsImagingRequest, self).prepare_test_result_data(line, patient)
