...
class ProductTemplate(models.Model):
    ...
    use_expiration_date = fields.Boolean(string="Date d'expiration",
    ...
    def onchange_expiration_date(self):
        if self.categ_id:
            self.expiration_time = self.categ_id.expiration_time
            self.use_time = self.categ_id.use_time
            self.removal_time = self.categ_id.removal_time
            self.alert_time = self.categ_id.alert_time
