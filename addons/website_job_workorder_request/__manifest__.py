...
Job Order/Configuration/Projects
Job Order/Configuration/Stages
Job Order/Job Orders
Job Order/Job Orders/Job Orders
Job Order/Purchase Requisitions
Job Order/Purchase Requisitions/Purchase Requisitions
...
progress bill
progress customer bill
progress customer billing odoo
odoo progress billings
progress billing report
odoo progress invoice
construction progress billing
job order progress billing
construction progress bill
construction progress billing odoo
job order progress bill
customer bill
customer progress bill
billing report
...
""",
    'images': ['static/description/wjwr.png'],
    # 'live_test_url' : 'https://youtu.be/iRA3emFeDU4',
    'live_test_url' : 'https://probuseappdemo.com/probuse_apps/website_job_workorder_request/941',#'https://youtu.be/O6yVI1NG5W8 ',
    #'live_test_url': 'https://youtu.be/GMm_ULB4ipY',
    'data': [
        'security/ir.model.access.csv',
        'report/joborder_report.xml',
        'data/job_order_category_data.xml',
        ...
        'views/job_order_category_view.xml',
    ],
    'installable': True,
    'auto_install': False,
}
