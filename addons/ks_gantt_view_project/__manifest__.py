...
""",
	...
	'data': ['data/ks_task_due_alert.xml', 'views/ks_gantt_task.xml', 'views/ks_gantt_project_views.xml', 'views/ks_project_task.xml', 'views/ks_project_all_task.xml', 'views/ks_gantt_view_project_assets.xml', 'views/ks_gantt_import_wizard.xml', 'reports/ks_tasks_report.xml', 'reports/ks_timesheet_report.xml', 'security/ir.model.access.csv'],
}
