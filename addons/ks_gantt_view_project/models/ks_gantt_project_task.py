...
class KsProjectTask(models.Model):
    ...
    ks_resource_hours_per_day = fields.Float(related='user_id.employee_id.resource_calendar_id.hours_per_day')
    ...
    def create(self, values):
        ...
        for task in res:
            if task.project_id.privacy_visibility == 'portal' or res.project_id.privacy_visibility == 'employees' or \
                    res.project_id.privacy_visibility == 'followers':
