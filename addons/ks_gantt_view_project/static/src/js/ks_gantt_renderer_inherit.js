        ...
        willStart: function () {
            ...
            if (this.active_id && this.ks_model_name == 'project.task') {
                ks_def = this._rpc({
                    ...
                    this.ks_project_start = result.ks_project_start ? result.ks_project_start : false;
                    this.ks_project_end = result.ks_project_end ? result.ks_project_end : false;
                    ...
                    this.ks_project_tooltip_config = result.ks_project_tooltip_config ? result.ks_project_tooltip_config : false;
