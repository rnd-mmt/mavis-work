...
class ProductCategory(models.Model):
    ...
    property_account_analytic_categ_id = fields.Many2one('account.analytic.account', company_dependent=True,
                                                         string='Compte analytique',
                                                         domain=lambda self: [("company_id", "=", self.env.company.id)],
                                                         help="Compte analytique")
    property_account_tags_categ_id = fields.Many2many('account.analytic.tag',
                                                      domain=lambda self: [("company_id", "=", self.env.company.id)],
