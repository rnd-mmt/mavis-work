...
class ProductProduct(models.Model):
    ...
    # categ_id = fields.Many2one(related='product_tmpl_id.categ_id', store=True)
...
#     to_weight = fields.Boolean(string='To Weigh With Scale', help="Check if the product should be weighted using the hardware scale integration.")
#     pos_categ_id = fields.Many2one(
#         'product.category', string='Point of Sale Category',  # Changement : 'pos.category' -> 'product.category'
#         domain="[('is_nomenclature', '=', True)]",  # Ajout d'un domaine pour filtrer sur is_nomenclature
#         help="Category used in the Point of Sale.")
