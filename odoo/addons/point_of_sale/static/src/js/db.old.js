odoo.define('point_of_sale.DB', function (require) {
    ...
    var PosDB = core.Class.extend({
        ...
        get_product_by_category: function (category_id) {
            console.log('🛍️----------------  Récupération des produits de la catégorie ID :', category_id);
            console.log('🛍️----------------  Produits par catégorie stockés :', this.product_by_category_id);
            var product_ids = this.product_by_category_id[category_id];
            console.log('🛍️----------------  IDs des produits dans la catégorie :', product_ids);
            var list = [];
            if (product_ids) {
