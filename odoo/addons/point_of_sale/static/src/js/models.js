odoo.define('point_of_sale.models', function (require) {
    ...
    exports.Order = Backbone.Model.extend({
        initialize: function (attributes, options) {
            ...
            this.set({ client: null, patient: null });
        ...
        init_from_JSON: function (json) {
            ...
            if (json.patient_id) {
                patient = this.pos.db.get_partner_by_id(json.patient_id);
                if (!patient) {
                    console.error('ERROR: trying to load a patient not available in the pos');
                }
            } else {
                patient = null;
            }
        ...
        export_as_JSON: function () {
            ...
            var json = {
                ...
                patient_id: this.get_patient() ? this.get_patient().id : false,
