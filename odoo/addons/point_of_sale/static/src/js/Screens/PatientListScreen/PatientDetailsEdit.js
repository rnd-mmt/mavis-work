odoo.define('point_of_sale.PatientDetailsEdit', function(require) {
    'use strict';
    ...
    class PatientDetailsEdit extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    PatientDetailsEdit.template = 'PatientDetailsEdit';

    Registries.Component.add(PatientDetailsEdit);
